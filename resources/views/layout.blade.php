...
<head>
    ...
    <meta name="description" content="E and T Auto Repair in Deer Park, Long Island, Suffolk County, NY services West Islip, Babylon, Dix Hills, Commack, Brentwood, Bayshore, Bright Waters towns.">
    ...
    <meta property="og:description" content="E and T Auto Repair in Deer Park, Long Island, Suffolk County, NY services West Islip, Babylon, Dix Hills, Commack, Brentwood, Bayshore, Bright Waters towns." />
            ...
            <div id="banner-box" class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="contact-head-text visible-xs visible-sm">
                        ...
                        <div class="">509-1 Commack Rd<br>Deer Park, NY 11729</div>



                        <div>M-F: 8:00AM - 5:30PM</div>
                        <div id="head-tele">T: (631) 586-7110</div>
                        <div class="guaranteed label">All Work Guaranteed!</div>
                ...
                <div class="col-md-4 hidden-sm hidden-xs contact-head-text">
                    ...
                    <p>509-1 Commack Rd | Deer Park, NY 11729</p>
        ...
        <div class="container">
            ...
            <ul class="nav nav-justified">
                ...
                <li>
                    ...
                    <a href="{{ URL::to('/contact') }}" aria-label="Contact" title="Contact"><i class="fa fa-envelope" aria-hidden="true"></i><span class="hidden-xs">Contact Us</span></a>
